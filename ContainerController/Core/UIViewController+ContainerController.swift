...
public extension UIViewController {
	...
	public func cc_setupContainerControllerIfNeeded(_ segue: UIStoryboardSegue, default segueIdentifier: ContainerController.StoryboardSegueIdentifier? = nil, didSetup: (() -> Void)? = nil) {
		if
